...
public class EasyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.leadereasy);
...
//        sort();
    ...
    public void showDatainListView() {
        databaseReference.orderByChild("Easy Score").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    long score = (long) ds.child("Easy Score").getValue();
