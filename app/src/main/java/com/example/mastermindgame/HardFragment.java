...
public class HardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.leaderhard);
...
//        sort();
    ...
    public void showDatainListView() {
        databaseReference.orderByChild("Hard Score").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    long score = (long) ds.child("Hard Score").getValue();
